    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh]">
      ...
      >
        ...
        <Command.List className="max-h-[320px] overflow-y-auto p-2">
          ...
          <Command.Group
            heading="Navigation"
            className="[&>[cmdk-group-heading]]:px-2 [&>[cmdk-group-heading]]:py-1 [&>[cmdk-group-heading]]:text-[10px] [&>[cmdk-group-heading]]:uppercase [&>[cmdk-group-heading]]:text-text-muted [&>[cmdk-group-heading]]:font-semibold"
          >
            {events.map((ev) => (
              <Command.Item
                key={ev.id}
          ...
          >
            <Command.Item
              ...
              onSelect={() =>
                runAndClose(() => {
                  ...
                  const { zoom, panOffsetX } = fitAllEvents(
                    events,
                    viewportWidth,
                  );
            ...
            <Command.Item
              ...
              onSelect={() =>
                runAndClose(() => useUiStore.getState().toggleDetailPanel())
              }
              className="px-2 py-1.5 text-xs rounded cursor-pointer text-text data-[selected=true]:bg-accent/10"
            >
              Toggle Detail Panel
